...
var MiniInfoCell = function MiniInfoCell(props) {
  ...
  var before = props.before,
      ...
      restProps = (0, _objectWithoutProperties2.default)(props, ["before", "after", "mode", "multiline", "children", "className"]);
  ...
  return /*#__PURE__*/_react.default.createElement(Component, (0, _extends2.default)({}, restProps, {
    className: (0, _classNames2.default)((0, _getClassName.default)('MiniInfoCell', platform), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "MiniInfoCell--md-".concat(mode), mode !== 'base'), (0, _defineProperty2.default)(_classNames, 'MiniInfoCell--mult', multiline), _classNames), className)
