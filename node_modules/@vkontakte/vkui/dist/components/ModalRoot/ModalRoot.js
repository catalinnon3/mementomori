...
var ModalRoot = /*#__PURE__*/function (_Component) {
  ...
  function ModalRoot(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onMaskClick", function () {
      if (!_this.state.switching) {
    ...
    _this.maskElementRef = _react.default.createRef();
  ...
  (0, _createClass2.default)(ModalRoot, [{
    ...
    value: function initActiveModal() {
      ...
      if (modalElement.querySelector('.ModalPage')) {
        modalState.type = _types.ModalType.PAGE;
      } else if (modalElement.querySelector('.ModalCard')) {
        modalState.type = _types.ModalType.CARD;
      }
    ...
    value: function onPageTouchMove(event, modalState) {
      ...
      if (!modalState.expandable || collapsed || expanded && modalState.touchMovePositive && modalState.touchStartContentScrollTop === 0 || target.closest('.ModalPage__header')) {
        ...
        var shiftYCurrent = (0, _touch.rubber)(shiftYPercent, 72, 0.8, this.props.platform === _platform.ANDROID);
    ...
    value: function onCardTouchMove(event, modalState) {
      ...
      if (target.closest('.ModalCard__container')) {
        ...
        var shiftYCurrent = (0, _touch.rubber)(shiftYPercent, 72, 1.2, this.props.platform === _platform.ANDROID);
        modalState.touchShiftYPercent = shiftYPercent;
    ...
    value: function waitTransitionFinish(modalState, eventHandler) {
      if (_supportEvents.transitionEvent.supported) {
        ...
        setTimeout(eventHandler, this.props.platform === _platform.ANDROID ? 320 : 400);
      }
    }
  }, {
    key: "switchPrevNext",
    ...
    value: function animateTranslate(modalState) {
      ...
      this.frameIds[frameId] = requestAnimationFrame(function () {
        (0, _styles.setTransformStyle)(modalState.innerElement, "translateY(".concat(currentPercent, "%)"));
      ...
      if (modalState.type === _types.ModalType.PAGE && modalState.expandable) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_TouchContext.default.Provider, {
        value: true
      }, /*#__PURE__*/_react.default.createElement(_ModalRootContext.default.Provider, {
        value: this.modalRootContext
      }, /*#__PURE__*/_react.default.createElement(_Touch.default, {
        className: (0, _classNames.default)((0, _getClassName.default)('ModalRoot', this.props.platform), {
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
          key: key,
          id: key,
          className: (0, _classNames.default)('ModalRoot__modal', {
...
(0, _defineProperty2.default)(ModalRoot, "contextTypes", {
...
var _default = (0, _withPlatform.default)(ModalRoot);
