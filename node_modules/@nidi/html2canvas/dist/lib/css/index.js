...
var duration_2 = require("./property-descriptors/duration");
var CSSParsedDeclaration = /** @class */ (function () {
    function CSSParsedDeclaration(declaration) {
        this.animationDuration = parse(duration_2.duration, declaration.animationDuration);
        ...
        this.transitionDuration = parse(duration_2.duration, declaration.transitionDuration);
    ...
    switch (descriptor.type) {
        ...
        case IPropertyDescriptor_1.PropertyDescriptorParsingType.TYPE_VALUE:
            switch (descriptor.format) {
                ...
                case 'duration':
                    return duration_1.duration.parse(parser.parseComponentValue());
            }
    }
