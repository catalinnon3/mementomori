...
var CanvasRenderer = /** @class */ (function () {
    ...
    CanvasRenderer.prototype.renderTextWithLetterSpacing = function (text, letterSpacing, lineHeight) {
        ...
        if (lineHeight === undefined) {
            ...
            var chars = css_line_break_1.toCodePoints(text.text).map(function (i) { return css_line_break_1.fromCodePoint(i); });
            var pos = textarea_layout_1.layout(chars, text.bounds.width, function (s, len) {
                ...
                switch (_b.label) {
                    ...
                    case 14:
                        ...
                        if (isTextInputElement(container) && container.value.length) {
                            ...
                            this.ctx.clip();
                            lineHeight = (container instanceof textarea_element_container_1.TextareaElementContainer) ? line_height_1.computeLineHeight(styles.lineHeight, styles.fontSize.number) : undefined;
                            this.renderTextWithLetterSpacing(new text_1.TextBounds(container.value, textBounds), styles.letterSpacing, lineHeight);
                            this.ctx.restore();
                            this.ctx.textBaseline = 'bottom';
